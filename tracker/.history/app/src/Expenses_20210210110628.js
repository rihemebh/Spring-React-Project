            ...
            <div>
                ...
                <Container style={{display : 'flex' , justifyContent: 'center', alignItems:'center', height:'100vh'}}>
                    <Form onSubmit={this.handleSumbit}>
                        <FormGroup>
                            <label style={{marginleft:"50px"}} for="title"> Title </label>
                            <input type="text" name="title" id="title" style={{marginleft:"50px"}}onChange={this.handleChange} autoComplete="name"></input>
                        </FormGroup>
                        <FormGroup>
                            <label style={{margin:"50px"}} for=" Category"> Category </label>
