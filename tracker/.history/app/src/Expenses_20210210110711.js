                ...
                <Container style={{display : 'flex' , justifyContent: 'center', alignItems:'center', height:'100vh'}}>
                    <Form onSubmit={this.handleSumbit}>
                        <FormGroup>
                            ...
                            <input type="text" name="title" id="title" style={{margin:"50px"}}onChange={this.handleChange} autoComplete="name"></input>
                        </FormGroup>
                        <FormGroup>
                            <label  for=" Category"> Category </label>
                            <input type="text" name=" Category" style={{margin:"50px"}} id=" Category" onChange={this.handleChange} ></input>
                        </FormGroup>
                        <FormGroup>
